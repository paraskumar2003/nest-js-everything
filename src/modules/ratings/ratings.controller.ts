...
export class RatingsController {
    ...
    async create(@Body() createRatingDto: CreateRatingDto) {
        ...
        this.logger.info('CREATE_RATING_REQUEST', journeyId, {
            dto: createRatingDto,
        });
    ...
    async findAll(@Query('active') active?: string) {
        ...
        this.logger.info('GET_RATINGS_RESPONSE', journeyId, {
            count: result.length,
        });
        return result;
    }
    ...
    async update(
        ...
        const journeyId = uuidv4();
        this.logger.info('UPDATE_RATING_REQUEST', journeyId, {
            id,
            dto: updateRatingDto,
        });
        ...
        this.logger.info('UPDATE_RATING_RESPONSE', journeyId, {
